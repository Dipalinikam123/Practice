...
import './Home.css'
import FaceAnimation from '../Componant/AnimationComponent';
import AnimationComponent from '../Componant/AnimationComponent';
        ...
        <div className="fluid-container  container-xl w-100 home-box">
            <div className="row pt-lg-5 pb-4 g-0 ">
                ...
                <div className="col-12 col-lg-6  fw-bold pt-md-5">
                    <div className="row g-0 text-box bg">
                        ...
                        <div className="col-12 col-lg-10  text-center text-md-center text-lg-start home-text">
                    ...
                    <div className="row icon-box gap-4 align-items-md-center justify-content-center justify-content-lg-start mt-5 mt-md-0 g-0">
